...
class TaxAdapter(val list : ArrayList<AllAmenitiesData>, val context : Context) :
    RecyclerView.Adapter<TaxAdapter.RoomsViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RoomsViewHolder {
        ...
        val view : View = inflater.inflate(R.layout.item_tax, parent, false)
