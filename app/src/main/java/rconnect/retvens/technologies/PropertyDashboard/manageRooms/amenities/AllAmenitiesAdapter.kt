...
class AllAmenitiesAdapter(val list : ArrayList<AllAmenitiesData>, val context : Context) :
    RecyclerView.Adapter<AllAmenitiesAdapter.AmenitiesViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AmenitiesViewHolder {
        ...
        val view : View = inflater.inflate(R.layout.item_all_amenities, parent, false)
