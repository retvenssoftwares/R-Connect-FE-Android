...
import rconnect.retvens.technologies.databinding.FragmentCancellationsBinding


class CancellationsFragment : Fragment() {


    private lateinit var bindingTab:FragmentCancellationsBinding
    ...
    override fun onCreateView(
        ...
        bindingTab = FragmentCancellationsBinding.inflate(layoutInflater,container,false)
