...
import rconnect.retvens.technologies.databinding.FragmentRevenueBinding


class RevenueFragment : Fragment() {

    private lateinit var bindingTab:FragmentRevenueBinding
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        // Inflate the layout for this fragment
       bindingTab = FragmentRevenueBinding.inflate(layoutInflater,container,false)
